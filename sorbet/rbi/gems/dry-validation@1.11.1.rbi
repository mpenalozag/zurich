...
class Dry::Validation::Evaluator
  ...
  # source://dry-validation//lib/dry/validation/evaluator.rb#19
...
class Dry::Validation::Macros::Container
  ...
  # source://dry-validation//lib/dry/validation/macros.rb#42
  def config; end
...
class Dry::Validation::Messages::Resolver
  ...
  # @return [Message, Message::Localized]
  #
  # source://dry-validation//lib/dry/validation/messages/resolver.rb#52
