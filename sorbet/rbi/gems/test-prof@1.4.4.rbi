...
module Process
  ...
  class << self
    # source://test-prof//lib/test_prof/core.rb#17
    def clock_gettime_for_test_prof(*_arg0); end

    # source://test-prof//lib/test_prof/core.rb#20
...
class TestProf::EventProf::Profiler
  ...
  # Returns the value of attribute per_example.
  #
  # source://test-prof//lib/test_prof/event_prof/profiler.rb#9
  def per_example?; end
...
class TestProf::EventProf::ProfilersGroup
  ...
  # source://test-prof//lib/test_prof/event_prof/profiler.rb#144
  def example_finished(id); end
...
# source://test-prof//lib/test_prof/factory_bot.rb#10
TestProf::FactoryBot = FactoryBot
...
module TestProf::FactoryDoctor
  ...
  class << self
    ...
    # source://test-prof//lib/test_prof/factory_doctor.rb#113
    def ignore!; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#117
    def ignore?; end
    ...
    # source://test-prof//lib/test_prof/factory_doctor.rb#121
    def within_factory(strategy); end

    private

    # source://test-prof//lib/test_prof/factory_doctor.rb#138
    def reset!; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#158
    def running?; end

    # source://test-prof//lib/test_prof/factory_doctor.rb#146
    def subscribe!; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#154
...
module TestProf::RSpecStamp
  ...
  class << self
    ...
    # source://test-prof//lib/test_prof/rspec_stamp.rb#172
    def quote(str); end
