...
# Please instead update this file by running `bin/tapioca dsl Story`.
...
class Story
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Story).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::Story).void)).returns(::Story) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::Story).void)
      ).returns(T::Array[::Story])
    end
    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Story).void)).returns(::Story) }
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Story).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Story])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Story).void).returns(T.nilable(::Story)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Story)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Story) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: ::Story).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Story]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Story]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Story)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Story) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Story) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Story).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Story).returns(BasicObject)).returns(T::Array[::Story]) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Story, T::Enumerable[T.any(::Story, T::Enumerable[::Story])])
    ...
    sig do
      params(
        other_array: T.any(::Story, T::Enumerable[T.any(::Story, T::Enumerable[::Story])])
      ).returns(T::Array[::Story])
    end
